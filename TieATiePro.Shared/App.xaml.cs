...
using TieATiePro.Services;

#if WINDOWS_APP
using Windows.System;
using Windows.UI.Core;
using Windows.UI.ApplicationSettings;
using TieATiePro.AppFlyouts;
#endif
...
namespace TieATiePro
{
    ...
    {
        private Guid APP_ID = new Guid("6e09dc9b-7eb0-43f8-b6a9-6a18e1dd5095");
        public const string APP_NAME = "Tie a tie pro";
